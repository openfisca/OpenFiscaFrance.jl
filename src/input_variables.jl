...
@define_variable(b1ac, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
...
@define_variable(b1cb, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  label = "Parts et actions de sociétés avec engagement de conservation de 6 ans minimum",
)

@define_variable(b1cd, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  label = "Droits sociaux de sociétés dans lesquelles vous exercez une fonction ou une activité",
)

@define_variable(b1ce, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  label = "Autres valeurs mobilières",
)

@define_variable(b1cf, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  label = "Liquidités",
)

@define_variable(b1cg, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
...
@define_variable(b2mt, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  label = "Réductions pour investissements directs dans une société",
)

@define_variable(b2ne, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  label = "Réductions pour investissements directs dans une société",
)

@define_variable(b2mv, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  label = "Réductions pour investissements par sociétés interposées, holdings",
)

@define_variable(b2nf, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  label = "Réductions pour investissements par sociétés interposées, holdings",
)

@define_variable(b2mx, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  label = "Réductions pour investissements par le biais de FIP",
)

@define_variable(b2na, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  label = "Réductions pour investissements par le biais de FCPI ou FCPR",
)

@define_variable(b2nc, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  label = "Réductions pour dons à certains organismes d'intérêt général",
)

@define_variable(b4rs, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  label = "Montant de l'impôt acquitté hors de France",
)

@define_variable(rev_or, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
)

@define_variable(rev_exo, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
)

@define_variable(tax_fonc, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  label = "Taxe foncière",
)
...
@define_variable(f6gi, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "6GI",
  label = "Pensions alimentaires versées à des enfants majeurs (décision de justice définitive avant 2006): 1er enfant",
)

@define_variable(f6gj, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "6GJ",
  label = "Pensions alimentaires versées à des enfants majeurs (décision de justice définitive avant 2006): 2eme enfant",
)

@define_variable(f6el, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "6EL",
...
@define_variable(f6em, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "6EM",
...
@define_variable(f6gp, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "6GP",
  label = "Autres pensions alimentaires versées décision de justice définitive avant 2006 (mineurs, ascendants)",
)

@define_variable(f6gu, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "6GU",
...
@define_variable(f6eu, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "6EU",
  label = "Frais d'accueil de personnes de plus de 75 ans dans le besoin",
)

@define_variable(f6ev, foyer_fiscal_definition, Int32, requested_period_last_value,
  cerfa_field = "6EV",
  label = "Nombre de personnes de plus de 75 ans dans le besoin accueillies sous votre toit",
)

@define_variable(f6dd, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "6DD",
  label = "Déductions diverses",
)

@define_variable(f6aa, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "6AA",
...
@define_variable(f6cc, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "CC",
...
@define_variable(f6eh, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "EH",
  start_date = Date(2005, 1, 1),
  stop_date = Date(2005, 12, 31),
...
@define_variable(f6da, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "DA",
...
@define_variable(f6cb, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "6CB",
...
@define_variable(f6hj, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "6HJ",
...
@define_variable(f6hk, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "6HK",
  label = "Dépenses de grosses réparations effectuées par les nus-propriétaires: report des dépenses des années antérieures",
...
@define_variable(f6hl, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "6HL",
  label = "Dépenses de grosses réparations effectuées par les nus-propriétaires: report des dépenses des années antérieures",
...
@define_variable(f6hm, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "6HM",
  label = "Dépenses de grosses réparations effectuées par les nus-propriétaires: report des dépenses des années antérieures",
...
@define_variable(f6gh, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "6GH",
  label = "Sommes à ajouter au revenu imposable",
)

@define_variable(f6fa, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "6FA",
...
@define_variable(f6fb, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "6FB",
  label = "Deficits globaux des années antérieures non encore déduits: année de perception des revenus -5",
)

@define_variable(f6fc, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "6FC",
  label = "Deficits globaux des années antérieures non encore déduits: année de perception des revenus -4",
)

@define_variable(f6fd, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "6FD",
  label = "Deficits globaux des années antérieures non encore déduits: année de perception des revenus -3",
)

@define_variable(f6fe, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "6FE",
  label = "Deficits globaux des années antérieures non encore déduits: année de perception des revenus -2",
)

@define_variable(f6fl, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "6FL",
...
@define_variable(f7xw, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7XW",
...
@define_variable(f7xy, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7XY",
...
@define_variable(f7va, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7VA",
...
@define_variable(f7vc, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7VC",
...
@define_variable(f7db, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7DB",
...
@define_variable(f7df, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7DF",
...
@define_variable(f7dq, foyer_fiscal_definition, Bool, requested_period_last_value,
  cerfa_field = "7DQ",
  label = "Emploi direct pour la première fois d'un salarié à domicile durant l'année de perception des revenus déclarés",
  start_date = Date(2009, 1, 1),
)

@define_variable(f7dg, foyer_fiscal_definition, Bool, requested_period_last_value,
  cerfa_field = "7DG",
...
@define_variable(f7dl, foyer_fiscal_definition, Int32, requested_period_default_value,
  cerfa_field = "7DL",
...
@define_variable(f7uh_2007, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7UH",
...
@define_variable(f7vy, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7VY",
...
@define_variable(f7vz, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7VZ",
...
@define_variable(f7vx, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7VX",
...
@define_variable(f7vw, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7VW",
...
@define_variable(f7vv, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7VV",
...
@define_variable(f7vu, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7VU",
...
@define_variable(f7vt, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7VT",
...
@define_variable(f7gf, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7GF",
...
@define_variable(f7gg, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7GG",
...
@define_variable(f7ea, foyer_fiscal_definition, Int32, requested_period_last_value,
  cerfa_field = "7EA",
  label = "Nombre d'enfants à charge poursuivant leurs études au collège",
)

@define_variable(f7eb, foyer_fiscal_definition, Int32, requested_period_last_value,
  cerfa_field = "7EB",
  label = "Nombre d'enfants à charge en résidence alternée poursuivant leurs études au collège",
)

@define_variable(f7ec, foyer_fiscal_definition, Int32, requested_period_last_value,
  cerfa_field = "7EC",
  label = "Nombre d'enfants à charge poursuivant leurs études au lycée",
)

@define_variable(f7ed, foyer_fiscal_definition, Int32, requested_period_last_value,
  cerfa_field = "7ED",
  label = "Nombre d'enfants à charge en résidence alternée poursuivant leurs études au lycée",
)

@define_variable(f7ef, foyer_fiscal_definition, Int32, requested_period_last_value,
  cerfa_field = "7EF",
  label = "Nombre d'enfants à charge poursuivant leurs études dans l'enseignement supérieur",
)

@define_variable(f7eg, foyer_fiscal_definition, Int32, requested_period_last_value,
  cerfa_field = "7EG",
  label = "Nombre d'enfants à charge en résidence alternée poursuivant leurs études dans l'enseignement supérieur",
)

@define_variable(f7td, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7TD",
...
@define_variable(f7vo, foyer_fiscal_definition, Int32, requested_period_last_value,
  cerfa_field = "7VO",
  label = "Nombre d'années de remboursement du prêt étudiant avant l'année de perception des revenus déclarés",
  start_date = Date(2006, 1, 1),
)

@define_variable(f7uk, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7UK",
  label = "Intérêts des prêts étudiants versés durant l'année de perception des revenus déclarés",
)

@define_variable(f7gz, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7GZ",
  label = "Primes de rente survie, contrats d'épargne handicap",
)

@define_variable(f7wm, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7WM",
  label = "Prestations compensatoires: Capital fixé en substitution de rente",
)

@define_variable(f7wn, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7WN",
  label = "Prestations compensatoires: Sommes versées l'année de perception des revenus déclarés",
)

@define_variable(f7wo, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7WO",
...
@define_variable(f7wp, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7WP",
  label = "Prestations compensatoires: Report des sommes décidées l'année de perception des revenus -1",
)

@define_variable(f7we, foyer_fiscal_definition, Bool, requested_period_last_value,
  cerfa_field = "7WE",
...
@define_variable(f7wg, foyer_fiscal_definition, Bool, requested_period_last_value,
  cell_format = "monetary",
  cerfa_field = "7WG",
...
@define_variable(f7wa, foyer_fiscal_definition, Int32, requested_period_default_value,
  cerfa_field = "7WA",
...
@define_variable(f7wb, foyer_fiscal_definition, Int32, requested_period_default_value,
  cerfa_field = "7WB",
...
@define_variable(f7wc, foyer_fiscal_definition, Int32, requested_period_default_value,
  cerfa_field = "7WC",
...
@define_variable(f7ve, foyer_fiscal_definition, Int32, requested_period_default_value,
  cerfa_field = "7VE",
...
@define_variable(f7vf, foyer_fiscal_definition, Int32, requested_period_default_value,
  cerfa_field = "7VF",
...
@define_variable(f7vg, foyer_fiscal_definition, Int32, requested_period_default_value,
  cerfa_field = "7VG",
...
@define_variable(f7sg, foyer_fiscal_definition, Int32, requested_period_default_value,
  cerfa_field = "7SG",
...
@define_variable(f7sj, foyer_fiscal_definition, Int32, requested_period_default_value,
  cerfa_field = "7SJ",
...
@define_variable(f7sk, foyer_fiscal_definition, Int32, requested_period_default_value,
  cerfa_field = "7SK",
  label = "Dépenses en faveur de la qualité environnementale de l'habitation principale: Volets isolants",
  start_date = Date(2012, 1, 1),
)

@define_variable(f7sl, foyer_fiscal_definition, Int32, requested_period_default_value,
  cerfa_field = "7SL",
...
@define_variable(f7sm, foyer_fiscal_definition, Int32, requested_period_default_value,
  cerfa_field = "7SM",
...
@define_variable(f7sn, foyer_fiscal_definition, Int32, requested_period_default_value,
  cerfa_field = "7SN",
...
@define_variable(f7so, foyer_fiscal_definition, Int32, requested_period_default_value,
  cerfa_field = "7SO",
...
@define_variable(f7sp, foyer_fiscal_definition, Int32, requested_period_default_value,
  cerfa_field = "7SP",
...
@define_variable(f7sq, foyer_fiscal_definition, Int32, requested_period_default_value,
  cerfa_field = "7SQ",
...
@define_variable(f7sr, foyer_fiscal_definition, Int32, requested_period_default_value,
  cerfa_field = "7SR",
...
@define_variable(f7ss, foyer_fiscal_definition, Int32, requested_period_default_value,
  cerfa_field = "7SS",
...
@define_variable(f7st, foyer_fiscal_definition, Int32, requested_period_default_value,
  cerfa_field = "7ST",
...
@define_variable(f7su, foyer_fiscal_definition, Int32, requested_period_default_value,
  cerfa_field = "7SU",
...
@define_variable(f7sv, foyer_fiscal_definition, Int32, requested_period_default_value,
  cerfa_field = "7SV",
  label = "Dépenses en faveur de la qualité environnementale de l'habitation principale: Diagnostic de performance énergétique",
  start_date = Date(2012, 1, 1),
)

@define_variable(f7sw, foyer_fiscal_definition, Int32, requested_period_default_value,
  cerfa_field = "7SW",
...
@define_variable(f7wq, foyer_fiscal_definition, Bool, requested_period_last_value,
  cerfa_field = "7WQ",
...
@define_variable(f7ws, foyer_fiscal_definition, Bool, requested_period_last_value,
  cerfa_field = "7WS",
...
@define_variable(f7wt, foyer_fiscal_definition, Bool, requested_period_last_value,
  cerfa_field = "7WT",
...
@define_variable(f7wu, foyer_fiscal_definition, Bool, requested_period_last_value,
  cerfa_field = "7WU",
...
@define_variable(f7wv, foyer_fiscal_definition, Bool, requested_period_last_value,
  cerfa_field = "7WV",
...
@define_variable(f7ww, foyer_fiscal_definition, Bool, requested_period_last_value,
  cerfa_field = "7WW",
...
@define_variable(f7wx, foyer_fiscal_definition, Bool, requested_period_last_value,
  cerfa_field = "7WX",
...
@define_variable(f7wh, foyer_fiscal_definition, Bool, requested_period_last_value,
  cerfa_field = "7WH",
...
@define_variable(f7wk, foyer_fiscal_definition, Bool, requested_period_last_value,
  cerfa_field = "7WK",
  label = "Votre habitation principale est une maison individuelle",
  start_date = Date(2009, 1, 1),
)

@define_variable(f7wf, foyer_fiscal_definition, Bool, requested_period_last_value,
  cerfa_field = "7WF",
...
@define_variable(f7wi, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7WI",
...
@define_variable(f7wj, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7WJ",
...
@define_variable(f7wl, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7WL",
...
@define_variable(f7wr, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7WR",
...
@define_variable(f7ur, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7UR",
...
@define_variable(f7oz, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7OZ",
...
@define_variable(f7pz, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7PZ",
...
@define_variable(f7qz, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7QZ",
...
@define_variable(f7rz, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7RZ",
...
@define_variable(f7qv, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7QV",
...
@define_variable(f7qo, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7QO",
...
@define_variable(f7qp, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7QP",
...
@define_variable(f7pa, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7PA",
...
@define_variable(f7pb, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7PB",
...
@define_variable(f7pc, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7PC",
...
@define_variable(f7pd, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7PD",
...
@define_variable(f7qe, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7QE",
...
@define_variable(f7pe, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7PE",
...
@define_variable(f7pf, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7PF",
  label = "Investissements outre-mer dans le cadre de l'entreprise : Autres investissements ayant fait l'objet en 2010 d'une demande d'agrément, d'une déclaration d'ouverture de chantier ou d'un accompte d'au moins 50%, Investissements donnés en location à une entreprise exploitante à laquelle vous rétrocédez la réduction d'impôt à hauteur de 62,5%",
  stop_date = Date(2011, 12, 31),
...
@define_variable(f7pg, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7PG",
...
@define_variable(f7ph, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7PH",
...
@define_variable(f7pi, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7PI",
...
@define_variable(f7pj, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7PJ",
...
@define_variable(f7pk, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7PK",
...
@define_variable(f7pl, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7PL",
...
@define_variable(f7pm, foyer_fiscal_definition, Int32, requested_period_default_value,
  cerfa_field = "7PM",
...
@define_variable(f7pn, foyer_fiscal_definition, Int32, requested_period_default_value,
  cerfa_field = "7PN",
...
@define_variable(f7po, foyer_fiscal_definition, Int32, requested_period_default_value,
  cerfa_field = "7PO",
  label = "Investissements outre-mer dans le cadre de l'entreprise : Investissements réalisés en 2012, Investissements ayant fait l'objet en 2009 d'une demande d'agrément, d'une déclaration d'ouverture de chantier ou d'un acompte d'au moins 50%, investissements donnés en location à une entreprise exploitante à laquelle vous rétrocédez la réduction d'impôt à hauteur de 60 %",
  stop_date = Date(2013, 12, 31),
)

@define_variable(f7pp, foyer_fiscal_definition, Int32, requested_period_default_value,
  cerfa_field = "7PP",
...
@define_variable(f7pq, foyer_fiscal_definition, Int32, requested_period_default_value,
  cerfa_field = "7PQ",
...
@define_variable(f7pr, foyer_fiscal_definition, Int32, requested_period_default_value,
  cerfa_field = "7PR",
...
@define_variable(f7ps, foyer_fiscal_definition, Int32, requested_period_default_value,
  cerfa_field = "7PS",
...
@define_variable(f7pt, foyer_fiscal_definition, Int32, requested_period_default_value,
  cerfa_field = "7PT",
  label = "Investissements outre-mer dans le cadre de l'entreprise : Investissements réalisés en 2012, Investissements ayant fait l'objet en 2010 d'une demande d'agrément, d'une déclaration d'ouverture de chantier ou d'un acompte d'au moins 50%, investissements donnés en location à une entreprise exploitante à laquelle vous rétrocédez la réduction d'impôt à hauteur de 60 %",
  stop_date = Date(2013, 12, 31),
)

@define_variable(f7pu, foyer_fiscal_definition, Int32, requested_period_default_value,
  cerfa_field = "7PU",
...
@define_variable(f7pv, foyer_fiscal_definition, Int32, requested_period_default_value,
  cerfa_field = "7PV",
...
@define_variable(f7pw, foyer_fiscal_definition, Int32, requested_period_default_value,
  cerfa_field = "7PW",
...
@define_variable(f7px, foyer_fiscal_definition, Int32, requested_period_default_value,
  cerfa_field = "7PX",
  label = "Investissements outre-mer dans le cadre de l'entreprise : Investissements réalisés en 2012, Investissements ayant fait l'objet en 2011 d'une demande d'agrément, d'une déclaration d'ouverture de chantier ou d'un acompte d'au moins 50%, investissements donnés en location à une entreprise exploitante à laquelle vous rétrocédez la réduction d'impôt  à hauteur de 52,63 %",
  stop_date = Date(2013, 12, 31),
)

@define_variable(f7py, foyer_fiscal_definition, Int32, requested_period_default_value,
  cerfa_field = "7PY",
  label = "Investissements outre-mer dans le cadre de l'entreprise : Investissements réalisés en 2012, Investissements ayant fait l'objet en 2011 d'une demande d'agrément, d'une déclaration d'ouverture de chantier ou d'un acompte d'au moins 50%, investissements donnés en location à une entreprise exploitante à laquelle vous rétrocédez la réduction d'impôt à hauteur de 62,5 %",
  start_date = Date(2012, 1, 1),
)

@define_variable(f7rg, foyer_fiscal_definition, Int32, requested_period_default_value,
  cerfa_field = "7RG",
...
@define_variable(f7rh, foyer_fiscal_definition, Int32, requested_period_default_value,
  cerfa_field = "7RH",
  label = "Investissements outre-mer dans le cadre de l'entreprise : Investissements réalisés en 2012, Investissements ayant fait l'objet en 2011 d'une demande d'agrément, d'une déclaration d'ouverture de chantier ou d'un acompte d'au moins 50%, investissements dans votre entreprise avec exploitation directe, montant de la réduction d'impôt calculée",
  start_date = Date(2012, 1, 1),
)

@define_variable(f7ri, foyer_fiscal_definition, Int32, requested_period_default_value,
  cerfa_field = "7RI",
  label = "Investissements outre-mer dans le cadre de l'entreprise : Investissements réalisés en 2012, Investissements ayant fait l'objet en 2011 d'une demande d'agrément, d'une déclaration d'ouverture de chantier ou d'un acompte d'au moins 50%, investissements dans votre entreprise avec exploitation directe, montant de la réduction d'impôt dont vous demandez l'imputation en 2012",
  start_date = Date(2012, 1, 1),
)

@define_variable(f7rj, foyer_fiscal_definition, Int32, requested_period_default_value,
  cerfa_field = "7RJ",
...
@define_variable(f7rk, foyer_fiscal_definition, Int32, requested_period_default_value,
  cerfa_field = "7RK",
...
@define_variable(f7rl, foyer_fiscal_definition, Int32, requested_period_default_value,
  cerfa_field = "7RL",
  label = "Investissements outre-mer dans le cadre de l'entreprise : Investissements ayant fait l'objet en 2009 d'une demande d'agrément, d'une déclaration d'ouverture de chantier ou d'un acompte d'au moins 50 %, investissements donnés en location à une entreprise exploitante à laquelle vous rétrocédez la réduction d'impôt à hauteur de 62,5 %",
  start_date = Date(2012, 1, 1),
)

@define_variable(f7rm, foyer_fiscal_definition, Int32, requested_period_default_value,
  cerfa_field = "7RM",
...
@define_variable(f7rn, foyer_fiscal_definition, Int32, requested_period_default_value,
  cerfa_field = "7RN",
...
@define_variable(f7ro, foyer_fiscal_definition, Int32, requested_period_default_value,
  cerfa_field = "7RO",
...
@define_variable(f7rp, foyer_fiscal_definition, Int32, requested_period_default_value,
  cerfa_field = "7RP",
  label = "Investissements outre-mer dans le cadre de l'entreprise : Investissements ayant fait l'objet en 2010 d'une demande d'agrément, d'une déclaration d'ouverture de chantier ou d'un acompte d'au moins 50 %, investissements donnés en location à une entreprise exploitante à laquelle vous rétrocédez la réduction d'impôt à hauteur de 52,63 %",
  start_date = Date(2012, 1, 1),
)

@define_variable(f7rq, foyer_fiscal_definition, Int32, requested_period_default_value,
  cerfa_field = "7RQ",
  label = "Investissements outre-mer dans le cadre de l'entreprise : Investissements ayant fait l'objet en 2010 d'une demande d'agrément, d'une déclaration d'ouverture de chantier ou d'un acompte d'au moins 50 %, investissements donnés en location à une entreprise exploitante à laquelle vous rétrocédez la réduction d'impôt à hauteur de 62,5 %",
  start_date = Date(2012, 1, 1),
)

@define_variable(f7rr, foyer_fiscal_definition, Int32, requested_period_default_value,
  cerfa_field = "7RR",
...
@define_variable(f7rs, foyer_fiscal_definition, Int32, requested_period_default_value,
  cerfa_field = "7RS",
  label = "Investissements outre-mer dans le cadre de l'entreprise : Investissements ayant fait l'objet en 2010 d'une demande d'agrément, d'une déclaration d'ouverture de chantier ou d'un acompte d'au moins 50 %, investissements dans votre entreprise avec exploitation directe, montant de la réduction d'impôt calculée",
  start_date = Date(2012, 1, 1),
)

@define_variable(f7rt, foyer_fiscal_definition, Int32, requested_period_default_value,
  cerfa_field = "7RT",
  label = "Investissements outre-mer dans le cadre de l'entreprise : Investissements ayant fait l'objet en 2010 d'une demande d'agrément, d'une déclaration d'ouverture de chantier ou d'un acompte d'au moins 50 %, investissements dans votre entreprise avec exploitation directe, montant de la réduction d'impôt dont vous demandez l'imputation en 2012",
  start_date = Date(2012, 1, 1),
)

@define_variable(f7ru, foyer_fiscal_definition, Int32, requested_period_default_value,
  cerfa_field = "7RU",
  label = "Investissements outre-mer dans le cadre de l'entreprise : Investissements ayant fait l'objet en 2011 d'une demande d'agrément, d'une déclaration d'ouverture de chantier ou d'un acompte d'au moins 50 %, investissements donnés en location à une entreprise exploitante à laquelle vous rétrocédez la réduction d'impôt à hauteur de 52,63 %",
  start_date = Date(2012, 1, 1),
)

@define_variable(f7rv, foyer_fiscal_definition, Int32, requested_period_default_value,
  cerfa_field = "7RV",
  label = "Investissements outre-mer dans le cadre de l'entreprise : Investissements ayant fait l'objet en 2011 d'une demande d'agrément, d'une déclaration d'ouverture de chantier ou d'un acompte d'au moins 50 %, investissements donnés en location à une entreprise exploitante à laquelle vous rétrocédez la réduction d'impôt à hauteur de 62,5 %",
  start_date = Date(2012, 1, 1),
)

@define_variable(f7rw, foyer_fiscal_definition, Int32, requested_period_default_value,
  cerfa_field = "7RW",
...
@define_variable(f7rx, foyer_fiscal_definition, Int32, requested_period_default_value,
  cerfa_field = "7RX",
  label = "Investissements outre-mer dans le cadre de l'entreprise : Investissements ayant fait l'objet en 2011 d'une demande d'agrément, d'une déclaration d'ouverture de chantier ou d'un acompte d'au moins 50 %, investissements dans votre entreprise avec exploitation directe, montant de la réduction d'impôt calculée",
  start_date = Date(2012, 1, 1),
)

@define_variable(f7ry, foyer_fiscal_definition, Int32, requested_period_default_value,
  cerfa_field = "7RY",
  label = "Investissements outre-mer dans le cadre de l'entreprise : Investissements ayant fait l'objet en 2011 d'une demande d'agrément, d'une déclaration d'ouverture de chantier ou d'un acompte d'au moins 50 %, investissements dans votre entreprise avec exploitation directe, montant de la réduction d'impôt dont vous demandez l'imputation en 2012",
  start_date = Date(2012, 1, 1),
)

@define_variable(f7nu, foyer_fiscal_definition, Int32, requested_period_default_value,
  cerfa_field = "7NU",
  label = "Investissements outre-mer dans le cadre de l'entreprise : Investissements autres que ceux des lignes précédentes, investissements donnés en location à une entreprise exploitante à laquelle vous rétrocédez la réduction d'impôt à hauteur de 52,63 %",
  start_date = Date(2012, 1, 1),
)

@define_variable(f7nv, foyer_fiscal_definition, Int32, requested_period_default_value,
  cerfa_field = "7NV",
  label = "Investissements outre-mer dans le cadre de l'entreprise : Investissements autres que ceux des lignes précédentes, investissements donnés en location à une entreprise exploitante à laquelle vous rétrocédez la réduction d'impôt à hauteur de 62,5 %",
  start_date = Date(2012, 1, 1),
)

@define_variable(f7nw, foyer_fiscal_definition, Int32, requested_period_default_value,
  cerfa_field = "7NW",
...
@define_variable(f7nx, foyer_fiscal_definition, Int32, requested_period_default_value,
  cerfa_field = "7NX",
...
@define_variable(f7ny, foyer_fiscal_definition, Int32, requested_period_default_value,
  cerfa_field = "7NY",
...
@define_variable(f7mn, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7MN",
...
@define_variable(f7lh, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7LH",
...
@define_variable(f7mb, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7MB",
  label = "Investissements outre-mer dans le cadre de l'entreprise REPORT : Investissements réalisés en 2010, Investissements ayant fait l'objet en 2009 d'une demande d'agrément, d'une déclaration d'ouverture de chantier ou d'un accompte d'au moins 50%, Investissements donnés en location à une entreprise exploitante à laquelle vous rétrocédez la réduction d'impôt à hauteur de 60%",
  start_date = Date(2011, 1, 1),
...
@define_variable(f7kt, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7KT",
...
@define_variable(f7li, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7LI",
...
@define_variable(f7mc, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7MC",
...
@define_variable(f7ku, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7KU",
...
@define_variable(f7sz, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7SZ",
...
@define_variable(fhsa, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "HSA",
...
@define_variable(fhsb, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "HSB",
...
@define_variable(fhsf, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "HSF",
...
@define_variable(fhsg, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "HSG",
...
@define_variable(fhsc, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "HSC",
...
@define_variable(fhsh, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "HSH",
...
@define_variable(fhsd, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "HSD",
...
@define_variable(fhsi, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "HSI",
...
@define_variable(fhse, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "HSE",
...
@define_variable(fhsj, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "HSJ",
...
@define_variable(fhsk, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "HSK",
...
@define_variable(fhsl, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "HSL",
  label = "Investissements outre-mer dans le cadre de l'entreprise : Autres investissements, Investissements ayant fait l’objet en 2010 ou 2011 d’une demande d’agrément, d’une déclaration d’ouverture de chantier ou d’un acompte d’au moins 50 %, Investissements donnés en location à une entreprise exploitante à laquelle vous rétrocédez la réduction d’impôt en 2010 à hauteur de 62,5%",
  start_date = Date(2013, 1, 1),
...
@define_variable(fhsp, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "HSP",
...
@define_variable(fhsq, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "HSQ",
  label = "Investissements outre-mer dans le cadre de l'entreprise : Autres investissements, Investissements ayant fait l’objet en 2010 ou 2011 d’une demande d’agrément, d’une déclaration d’ouverture de chantier ou d’un acompte d’au moins 50 %, Investissements donnés en location à une entreprise exploitante à laquelle vous rétrocédez la réduction d’impôt en 2011 à hauteur de 62,5%",
  start_date = Date(2013, 1, 1),
...
@define_variable(fhsm, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "HSM",
...
@define_variable(fhsr, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "HSR",
...
@define_variable(fhsn, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "HSN",
...
@define_variable(fhss, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "HSS",
...
@define_variable(fhso, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "HSO",
...
@define_variable(fhst, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "HST",
...
@define_variable(fhsu, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "HSU",
...
@define_variable(fhsv, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "HSV",
  label = "Investissements outre-mer dans le cadre de l'entreprise : Autres investissements, Investissements ayant fait l’objet en 2012 d’une demande d’agrément, d’une déclaration d’ouverture de chantier ou d’un acompte d’au moins 50 %, Investissements donnés en location à une entreprise exploitante à laquelle vous rétrocédez la réduction d’impôt à hauteur de 62,5%",
  start_date = Date(2013, 1, 1),
...
@define_variable(fhsw, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "HSW",
...
@define_variable(fhsx, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "HSX",
...
@define_variable(fhsy, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "HS",
...
@define_variable(fhsz, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "HSZ",
  label = "Investissements outre-mer dans le cadre de l'entreprise : Investissements autres que ceux des lignes précédentes, Investissements donnés en location à une entreprise exploitante à laquelle vous rétrocédez la réduction d’impôt à hauteur de 52,63%",
  start_date = Date(2013, 1, 1),
...
@define_variable(fhta, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "HTA",
  label = "Investissements outre-mer dans le cadre de l'entreprise : Investissements autres que ceux des lignes précédentes, Investissements donnés en location à une entreprise exploitante à laquelle vous rétrocédez la réduction d’impôt à hauteur de 62,5%",
  start_date = Date(2013, 1, 1),
...
@define_variable(fhtb, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "HTB",
  label = "Investissements outre-mer dans le cadre de l'entreprise : Investissements autres que ceux des lignes précédentes, Investissements dans votre entreprise",
  start_date = Date(2013, 1, 1),
...
@define_variable(fhtc, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "HTC",
...
@define_variable(fhtd, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "HTD",
...
@define_variable(f7fy, foyer_fiscal_definition, Int32, requested_period_default_value,
  cerfa_field = "7FY",
...
@define_variable(f7gy, foyer_fiscal_definition, Int32, requested_period_default_value,
  cerfa_field = "7GY",
...
@define_variable(f7hy, foyer_fiscal_definition, Int32, requested_period_default_value,
  cerfa_field = "7HY",
...
@define_variable(f7ky, foyer_fiscal_definition, Int32, requested_period_default_value,
  cerfa_field = "7KY",
...
@define_variable(f7iy, foyer_fiscal_definition, Int32, requested_period_default_value,
  cerfa_field = "7IY",
  label = "Report du solde de réduction d'impôt non encore imputé sur les investissements réalisés",
  start_date = Date(2013, 1, 1),
)

@define_variable(f7ly, foyer_fiscal_definition, Int32, requested_period_default_value,
  cerfa_field = "7LY",
...
@define_variable(f7my, foyer_fiscal_definition, Int32, requested_period_default_value,
  cerfa_field = "7MY",
...
@define_variable(f7ra, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7RA",
...
@define_variable(f7rb, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7RB",
...
@define_variable(f7rc, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7RC",
  label = "Travaux de restauration immobilière dans un secteur sauvegardé ou assimilé",
  start_date = Date(2011, 1, 1),
...
@define_variable(f7rd, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7RD",
  label = "Travaux de restauration immobilière dans un secteur sauvegardé ou assimilé",
  start_date = Date(2011, 1, 1),
...
@define_variable(f7re, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7RE",
  label = "Travaux de restauration immobilière dans un secteur sauvegardé ou assimilé",
  start_date = Date(2012, 1, 1),
...
@define_variable(f7rf, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7RF",
  label = "Travaux de restauration immobilière dans un secteur sauvegardé ou assimilé",
  start_date = Date(2012, 1, 1),
...
@define_variable(f7sx, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7SX",
  label = "Travaux de restauration immobilière dans un secteur sauvegardé ou assimilé",
  start_date = Date(2013, 1, 1),
...
@define_variable(f7sy, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7SY",
  label = "Travaux de restauration immobilière dans un secteur sauvegardé ou assimilé",
  start_date = Date(2013, 1, 1),
...
@define_variable(f7gw, foyer_fiscal_definition, Int32, requested_period_default_value,
  cerfa_field = "7GW",
...
@define_variable(f7gx, foyer_fiscal_definition, Int32, requested_period_default_value,
  cerfa_field = "7GX",
...
@define_variable(f7xa, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7XA",
...
@define_variable(f7xb, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7XB",
...
@define_variable(f7xc, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7XC",
...
@define_variable(f7xd, foyer_fiscal_definition, Bool, requested_period_last_value,
  cerfa_field = "7XD",
...
@define_variable(f7xe, foyer_fiscal_definition, Bool, requested_period_last_value,
  cerfa_field = "7XE",
...
@define_variable(f7xf, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7XF",
...
@define_variable(f7xh, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7XH",
...
@define_variable(f7xi, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7XI",
  label = "Investissements locatifs dans le secteur de touristique, logement neuf: report des dépenses d'investissement des années antérieures",
  start_date = Date(2010, 1, 1),
...
@define_variable(f7xj, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7XJ",
...
@define_variable(f7xk, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7XK",
...
@define_variable(f7xl, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7XL",
...
@define_variable(f7xm, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7XM",
...
@define_variable(f7xn, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7XN",
  label = "Investissements locatifs dans le secteur de touristique, logement neuf: report des dépenses d'investissement des années antérieures",
  start_date = Date(2012, 1, 1),
...
@define_variable(f7xo, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7XO",
  label = "Investissements locatifs dans une résidence hôtelière à vocation sociale: report des dépenses d'investissement des années antérieures",
  start_date = Date(2008, 1, 1),
...
@define_variable(f7xp, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7XP",
  label = "Investissements locatifs dans une résidence hôtelière à vocation sociale: report des dépenses d'investissement des années antérieures",
  start_date = Date(2011, 1, 1),
...
@define_variable(f7xq, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7XQ",
  label = "Investissements locatifs dans une résidence hôtelière à vocation sociale: report des dépenses d'investissement des années antérieures",
  start_date = Date(2011, 1, 1),
...
@define_variable(f7xr, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7XR",
  label = "Investissements locatifs dans une résidence hôtelière à vocation sociale: report des dépenses d'investissement des années antérieures",
  start_date = Date(2011, 1, 1),
...
@define_variable(f7xv, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7XV",
...
@define_variable(f7xx, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7XX",
...
@define_variable(f7xz, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7XZ",
...
@define_variable(f7uy, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7UY",
  label = "Investissements locatifs dans le secteur de touristique: Report des dépenses d'investissement des années antérieures",
  start_date = Date(2013, 1, 1),
...
@define_variable(f7uz, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7UZ",
  label = "Investissements locatifs dans le secteur de touristique: Report des dépenses d'investissement des années antérieures",
  start_date = Date(2013, 1, 1),
...
@define_variable(f7cq, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7CQ",
...
@define_variable(f7cu, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7CU",
  label = "Souscriptions au capital des PME non cotées, montant versé au titre de souscriptions antérieures",
)

@define_variable(f7gs, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7GS",
...
@define_variable(f7ua, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7UA",
  stop_date = Date(2007, 12, 31),
)

@define_variable(f7ub, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7UB",
  stop_date = Date(2007, 12, 31),
)

@define_variable(f7uc, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7UC",
  label = "Cotisations pour la défense des forêts contre l'incendie ",
)

@define_variable(f7ui, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7UI",
  stop_date = Date(2008, 12, 31),
)

@define_variable(f7uj, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7UJ",
  stop_date = Date(2007, 12, 31),
)

@define_variable(f7qb, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7QB",
  stop_date = Date(2011, 12, 31),
)

@define_variable(f7qc, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7QC",
  stop_date = Date(2011, 12, 31),
)

@define_variable(f7qd, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7QD",
  stop_date = Date(2011, 12, 31),
)

@define_variable(f7qk, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7QK",
  stop_date = Date(2009, 12, 31),
)

@define_variable(f7qn, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7QN",
  stop_date = Date(2010, 12, 31),
)

@define_variable(f7kg, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7KG",
  stop_date = Date(2010, 12, 31),
)

@define_variable(f7ql, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7QL",
  stop_date = Date(2011, 12, 31),
)

@define_variable(f7qt, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7QT",
  stop_date = Date(2011, 12, 31),
)

@define_variable(f7qm, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7QM",
  stop_date = Date(2011, 12, 31),
)

@define_variable(f7qu, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7QU",
)

@define_variable(f7ki, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7KI",
)

@define_variable(f7qj, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7QJ",
)

@define_variable(f7qw, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7QW",
)

@define_variable(f7qx, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7QX",
)

@define_variable(f7qf, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7QF",
)

@define_variable(f7qg, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7QG",
)

@define_variable(f7qh, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7QH",
)

@define_variable(f7qi, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7QI",
)

@define_variable(f7qq, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7QQ",
)

@define_variable(f7qr, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7QR",
)

@define_variable(f7qs, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7QS",
)

@define_variable(f7mm, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7MM",
  start_date = Date(2010, 1, 1),
  stop_date = Date(2012, 12, 31),
...
@define_variable(f7lg, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7LG",
  start_date = Date(2010, 1, 1),
)

@define_variable(f7ma, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7MA",
  start_date = Date(2010, 1, 1),
)

@define_variable(f7ks, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7KS",
)

@define_variable(f7kh, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7KH",
)

@define_variable(f7oa, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7OA",
...
@define_variable(f7ob, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7OB",
...
@define_variable(f7oc, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7OC",
...
@define_variable(f7oh, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7OH",
...
@define_variable(f7oi, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7OI",
...
@define_variable(f7oj, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7OJ",
...
@define_variable(f7ok, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7OK",
...
@define_variable(f7ol, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7OL",
...
@define_variable(f7om, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7OM",
...
@define_variable(f7on, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7ON",
...
@define_variable(f7oo, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7OO",
...
@define_variable(f7op, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7OP",
...
@define_variable(f7oq, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7OQ",
...
@define_variable(f7or, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7OR",
...
@define_variable(f7os, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7OS",
...
@define_variable(f7ot, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7OT",
...
@define_variable(f7ou, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7OU",
...
@define_variable(f7ov, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7OV",
...
@define_variable(f7ow, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7OW",
...
@define_variable(fhod, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "HOD",
...
@define_variable(fhoe, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "HOE",
...
@define_variable(fhof, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "HOF",
...
@define_variable(fhog, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "HOG",
...
@define_variable(fhox, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "HOX",
...
@define_variable(fhoy, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "HOY",
...
@define_variable(fhoz, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "HOZ",
...
@define_variable(fhra, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "HRA",
...
@define_variable(fhrb, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "HRB",
...
@define_variable(fhrc, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "HRC",
...
@define_variable(fhrd, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "HRD",
...
@define_variable(f7gq, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7GQ",
  label = "Souscription de parts de fonds communs de placement dans l'innovation",
)

@define_variable(f7fq, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7FQ",
  label = "Souscription de parts de fonds d'investissement de proximité",
)

@define_variable(f7fm, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7FM",
...
@define_variable(f7fl, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7FL",
...
@define_variable(f7gn, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7GN",
...
@define_variable(f7fn, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7FN",
...
@define_variable(f7fh, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7FH",
  label = "Intérêts d'emprunt pour reprise de société",
)

@define_variable(f7ff, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7FF",
  label = "Frais de comptabilité et d'adhésion à un CGA (centre de gestion agréée) ou à une AA (association agréée)",
)

@define_variable(f7fg, foyer_fiscal_definition, Int32, requested_period_default_value,
  cerfa_field = "7FG",
  label = "Frais de comptabilité et d'adhésion à un CGA ou à une AA: nombre d'exploitations",
)

@define_variable(f7nz, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7NZ",
...
@define_variable(f7ka, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7KA",
...
@define_variable(f7kb, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7KB",
...
@define_variable(f7kc, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7KC",
  label = "Dépenses de protection du patrimoine naturel (excédent de réduction d’impôt d’années antérieures qui n’a pu être imputé)",
  start_date = Date(2012, 1, 1),
...
@define_variable(f7kd, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7KD",
  label = "Dépenses de protection du patrimoine naturel (excédent de réduction d’impôt d’années antérieures qui n’a pu être imputé)",
  start_date = Date(2013, 1, 1),
...
@define_variable(f7uh, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7UH",
...
@define_variable(f7un, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7UN",
  label = "Investissements forestiers: acquisition",
)

@define_variable(f7ul, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7UL",
...
@define_variable(f7uu, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7UU",
  label = "Investissements forestiers",
  start_date = Date(2010, 1, 1),
...
@define_variable(f7uv, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7UV",
  label = "Investissements forestiers",
  start_date = Date(2011, 1, 1),
...
@define_variable(f7uw, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7UW",
  label = "Investissements forestiers",
  start_date = Date(2012, 1, 1),
...
@define_variable(f7th, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7TH",
  label = "Investissements forestiers",
  start_date = Date(2013, 1, 1),
...
@define_variable(f7ux, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7UX",
  label = "Investissements forestiers",
  start_date = Date(2013, 1, 1),
...
@define_variable(f7tg, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7TG",
  label = "Investissements forestiers",
  start_date = Date(2012, 1, 1),
...
@define_variable(f7tf, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7TF",
  label = "Investissements forestiers",
  start_date = Date(2011, 1, 1),
...
@define_variable(f7ut, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7UT",
  label = "Investissements forestiers",
  start_date = Date(2009, 1, 1),
...
@define_variable(f7um, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7UM",
  label = "Intérêts pour paiement différé accordé aux agriculteurs",
)

@define_variable(f7hj, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7HJ",
...
@define_variable(f7hk, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7HK",
...
@define_variable(f7hn, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7HN",
...
@define_variable(f7ho, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7HO",
...
@define_variable(f7hl, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7HL",
...
@define_variable(f7hm, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7HM",
...
@define_variable(f7hr, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7HR",
...
@define_variable(f7hs, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7HS",
...
@define_variable(f7la, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7LA",
...
@define_variable(f7lb, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7LB",
...
@define_variable(f7lc, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7LC",
...
@define_variable(f7ld, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7LD",
...
@define_variable(f7le, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7LE",
...
@define_variable(f7lf, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7LF",
...
@define_variable(f7ls, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7LS",
...
@define_variable(f7lm, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7LM",
...
@define_variable(f7lz, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7LZ",
...
@define_variable(f7mg, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7MG",
...
@define_variable(f7na, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7NA",
...
@define_variable(f7nb, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7NB",
...
@define_variable(f7nc, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7NC",
...
@define_variable(f7nd, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7ND",
...
@define_variable(f7ne, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7NE",
...
@define_variable(f7nf, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7NF",
...
@define_variable(f7ng, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7NG",
  label = "Investissements locatifs neufs dispositif Scellier : investissements engagés en 2010, réalisés en 2011, ",
  start_date = Date(2011, 1, 1),
...
@define_variable(f7nh, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7NH",
...
@define_variable(f7ni, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7NI",
...
@define_variable(f7nj, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7NJ",
...
@define_variable(f7nk, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7NK",
...
@define_variable(f7nl, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7NL",
...
@define_variable(f7nm, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7NM",
...
@define_variable(f7nn, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7NN",
...
@define_variable(f7no, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7NO",
...
@define_variable(f7np, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7NP",
...
@define_variable(f7nq, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7NQ",
...
@define_variable(f7nr, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7NR",
...
@define_variable(f7ns, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7NS",
...
@define_variable(f7nt, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7NT",
...
@define_variable(f7hv, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7HV",
...
@define_variable(f7hw, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7HW",
...
@define_variable(f7hx, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7HX",
...
@define_variable(f7hz, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7HZ",
...
@define_variable(f7ht, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7HT",
...
@define_variable(f7hu, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7HU",
...
@define_variable(f7ha, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7HA",
...
@define_variable(f7hb, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7HB",
...
@define_variable(f7hg, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7HG",
...
@define_variable(f7hh, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7HH",
...
@define_variable(f7hd, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7HD",
...
@define_variable(f7he, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7HE",
...
@define_variable(f7hf, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7HF",
...
@define_variable(f7ja, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7JA",
...
@define_variable(f7jb, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7JB",
...
@define_variable(f7jd, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7JD",
...
@define_variable(f7je, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7JE",
...
@define_variable(f7jf, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7JF",
...
@define_variable(f7jg, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7JG",
...
@define_variable(f7jh, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7JH",
...
@define_variable(f7jj, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7JJ",
...
@define_variable(f7jk, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7JK",
...
@define_variable(f7jl, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7JL",
  label = "Investissements locatifs neufs dispositif Scellier : investissements engagés en 2011, réalisés en 2012, DOM, Saint-Barthélémy, Saint-Martin, Saint-Pierre-et-Miquelon",
  start_date = Date(2012, 1, 1),
...
@define_variable(f7jm, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7JM",
...
@define_variable(f7jn, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7JN",
...
@define_variable(f7jo, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7JO",
...
@define_variable(f7jp, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7JP",
  label = "Investissements locatifs neufs dispositif Scellier : investissements engagés en 2011, réalisés en 2012, Polynésie Française, Nouvelle Calédonie, Wallis et Futuna",
  start_date = Date(2012, 1, 1),
...
@define_variable(f7jq, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7JQ",
...
@define_variable(f7jr, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7JR",
...
@define_variable(f7gj, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7GJ",
...
@define_variable(f7gk, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7GK",
...
@define_variable(f7gl, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7GL",
...
@define_variable(f7gp, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7GP",
...
@define_variable(f7fa, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7FA",
...
@define_variable(f7fb, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7FB",
...
@define_variable(f7fc, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7FC",
...
@define_variable(f7fd, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7FD",
...
@define_variable(f7ij, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7IJ",
...
@define_variable(f7il, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7IL",
...
@define_variable(f7im, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7IM",
...
@define_variable(f7ik, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7IK",
...
@define_variable(f7in, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7IN",
...
@define_variable(f7iv, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7IV",
...
@define_variable(f7iw, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7IW",
...
@define_variable(f7io, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7IO",
...
@define_variable(f7ip, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7IP",
  label = "Investissements destinés à la location meublée non professionnelle : ",
  start_date = Date(2011, 1, 1),
...
@define_variable(f7ir, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7IR",
  label = "Investissements destinés à la location meublée non professionnelle : ",
  start_date = Date(2011, 1, 1),
...
@define_variable(f7iq, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7IQ",
  label = "Investissements destinés à la location meublée non professionnelle : ",
  start_date = Date(2011, 1, 1),
...
@define_variable(f7iu, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7IU",
  label = "Investissements destinés à la location meublée non professionnelle : ",
  start_date = Date(2011, 1, 1),
...
@define_variable(f7it, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7IT",
  label = "Investissements destinés à la location meublée non professionnelle : ",
  start_date = Date(2011, 1, 1),
...
@define_variable(f7is, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7IS",
...
@define_variable(f7ia, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7IA",
...
@define_variable(f7ib, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7IB",
...
@define_variable(f7ic, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7IC",
...
@define_variable(f7id, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7ID",
...
@define_variable(f7ie, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7IE",
...
@define_variable(f7if, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7IF",
...
@define_variable(f7ig, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7IG",
...
@define_variable(f7ix, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7IX",
...
@define_variable(f7ih, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7IH",
...
@define_variable(f7iz, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7IZ",
...
@define_variable(f7jt, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7JT",
...
@define_variable(f7ju, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7JU",
...
@define_variable(f7jv, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7JV",
...
@define_variable(f7jw, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7JW",
...
@define_variable(f7jx, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7JX",
...
@define_variable(f7jy, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7JY",
...
@define_variable(f7jc, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7JC",
...
@define_variable(f7ji, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7JI",
...
@define_variable(f7js, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7JS",
  label = "Investissements destinés à la location meublée non professionnelle : Investissements réalisés et achevés en 2011 ; réalisés en 2011 et achevés en 2011 ou 2012 ; réalisés en 2012 avec promesse d'achat en 2011 et achevés en 2012, Report du solde de réduction d’impôt de l’année 2012",
  start_date = Date(2013, 1, 1),
...
@define_variable(f7gt, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7GT",
...
@define_variable(f7gu, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7GU",
...
@define_variable(f7gv, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7GV",
...
@define_variable(f7xg, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7XG",
...
@define_variable(f7uo, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7UO",
  label = "Acquisition de biens culturels",
)

@define_variable(f7us, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7US",
  label = "Réduction d'impôt mécénat d'entreprise",
)

@define_variable(f7sb, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7SB",
...
@define_variable(f7sc, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7SC",
...
@define_variable(f7sd, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7SD",
...
@define_variable(f7se, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7SE",
...
@define_variable(f7sh, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7SH",
...
@define_variable(f7up, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7UP",
...
@define_variable(f7uq, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7UQ",
...
@define_variable(f7si, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7SI",
...
@define_variable(f7te, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7TE",
...
@define_variable(f7tu, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7TU",
...
@define_variable(f7tt, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7TT",
  label = "Dépenses de travaux dans l'habitation principale",
  start_date = Date(2012, 1, 1),
...
@define_variable(f7tv, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7TV",
  label = "Dépenses de travaux dans l'habitation principale",
  start_date = Date(2012, 1, 1),
...
@define_variable(f7tx, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7TX",
  label = "Dépenses de travaux dans l'habitation principale",
  start_date = Date(2012, 1, 1),
...
@define_variable(f7ty, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7TY",
  label = "Dépenses de travaux dans l'habitation principale",
  start_date = Date(2012, 1, 1),
...
@define_variable(f7tw, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7TW",
  label = "Dépenses de travaux dans l'habitation principale",
  start_date = Date(2012, 1, 1),
...
@define_variable(f7gh, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7GH",
...
@define_variable(f7gi, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "7GI",
...
@define_variable(f8tg, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "8TG",
...
@define_variable(f8to, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "8TO",
  label = "Crédit d'impôt en faveur des entreprises: investissement en Corse, report non imputé les années antérieures",
)

@define_variable(f8tp, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "8TP",
  label = "Crédit d'impôt en faveur des entreprises: investissement en Corse, reprise de crédit d'impôt",
)

@define_variable(f8ts, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "8TS",
...
@define_variable(f8uz, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "8UZ",
  label = "Crédit d'impôt en faveur des entreprises: Famille",
)

@define_variable(f8uw, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "8UW",
...
@define_variable(f8tz, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "8TZ",
  label = "Crédit d'impôt en faveur des entreprises: Apprentissage",
)

@define_variable(f8wa, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "8WA",
  label = "Crédit d'impôt en faveur des entreprises: Agriculture biologique",
)

@define_variable(f8wb, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "8WB",
  label = "Crédit d'impôt en faveur des entreprises: Prospection commerciale",
)

@define_variable(f8wc__2008, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "8WC",
...
@define_variable(f8wc, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "8WC",
...
@define_variable(f8wd, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "8WD",
...
@define_variable(f8we, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "8WE",
...
@define_variable(f8wr, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "8WR",
...
@define_variable(f8ws, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "8WS",
...
@define_variable(f8wt, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "8WT",
...
@define_variable(f8wu, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "8WU",
...
@define_variable(f8wv, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "8WV",
...
@define_variable(f8wx, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = "8WX",
...
@define_variable(elig_creimp_exc_2008, foyer_fiscal_definition, Int32, requested_period_default_value,
  cell_default = 1,
  cell_format = "monetary",
...
@define_variable(idfoy, individu_definition, Int32, permanent_default_value,
  label = "Identifiant du foyer",
  permanent = true,
)

@define_variable(idfam, individu_definition, Int32, permanent_default_value,
...
@define_variable(birth, individu_definition, Date, permanent_default_value,
...
@define_variable(allocation_securisation_professionnelle, individu_definition, Float32, requested_period_default_value,
  label = "Allocation de sécurisation professionnelle",
)

@define_variable(prime_forfaitaire_mensuelle_reprise_activite, individu_definition, Float32, requested_period_default_value,
  label = "Prime forfaitaire mensuelle pour la reprise d'activité",
)

@define_variable(indemnites_volontariat, individu_definition, Float32, requested_period_default_value,
  label = "Indemnités de volontariat",
)

@define_variable(dedommagement_victime_amiante, individu_definition, Float32, requested_period_default_value,
  label = "Dédommagement versé aux victimes de l'amiante",
)

@define_variable(prestation_compensatoire, individu_definition, Float32, requested_period_default_value,
  label = "Dédommagement versé aux victimes de l'amiante",
)
...
@define_variable(ppe_du_ns, individu_definition, Int32, requested_period_default_value,
  cerfa_field = [0 => "5NV", 1 => "5OV", 2 => "5PV"],
  label = "Prime pour l'emploi des non-salariés: nombre de jours travaillés dans l'année",
  stop_date = Date(2006, 12, 31),
)

@define_variable(ppe_tp_ns, individu_definition, Bool, requested_period_last_value,
...
@define_variable(frag_exon, individu_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
...
@define_variable(frag_impo, individu_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
...
@define_variable(arag_exon, individu_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
...
@define_variable(arag_impg, individu_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
...
@define_variable(arag_defi, individu_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
...
@define_variable(nrag_exon, individu_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
...
@define_variable(nrag_impg, individu_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
...
@define_variable(nrag_defi, individu_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
...
@define_variable(nrag_ajag, individu_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
...
@define_variable(ebic_impv, individu_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
...
@define_variable(ebic_imps, individu_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
...
@define_variable(ebnc_impo, individu_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
...
@define_variable(mbic_exon, individu_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
...
@define_variable(abic_exon, individu_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
...
@define_variable(nbic_exon, individu_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
...
@define_variable(mbic_impv, individu_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
...
@define_variable(mbic_imps, individu_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
...
@define_variable(abic_impn, individu_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
...
@define_variable(abic_imps, individu_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
...
@define_variable(nbic_impn, individu_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
...
@define_variable(nbic_imps, individu_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
...
@define_variable(nbic_mvct, individu_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = [0 => "5KJ", 1 => "5LJ", 2 => "5MJ"],
...
@define_variable(abic_defn, individu_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
...
@define_variable(abic_defs, individu_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
...
@define_variable(nbic_defn, individu_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
...
@define_variable(nbic_defs, individu_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
...
@define_variable(nbic_apch, individu_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = [0 => "5KS", 1 => "5LS", 2 => "5MS"],
  label = "Artisans pêcheurs : abattement 50% avec CGA ou viseur (régime du bénéfice réel)",
)

@define_variable(macc_exon, individu_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
...
@define_variable(aacc_exon, individu_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
...
@define_variable(nacc_exon, individu_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
...
@define_variable(macc_impv, individu_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
...
@define_variable(macc_imps, individu_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
...
@define_variable(aacc_impn, individu_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
...
@define_variable(aacc_imps, individu_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
...
@define_variable(aacc_defn, individu_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
...
@define_variable(aacc_gits, individu_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
...
@define_variable(nacc_impn, individu_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
...
@define_variable(aacc_defs, individu_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = [0 => "5NG", 1 => "5OG", 2 => "5PG"],
...
@define_variable(nacc_meup, individu_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
...
@define_variable(nacc_defn, individu_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
...
@define_variable(nacc_defs, individu_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
...
@define_variable(mncn_impo, individu_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
...
@define_variable(cncn_bene, individu_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
...
@define_variable(cncn_defi, individu_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
...
@define_variable(mbnc_exon, individu_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
...
@define_variable(abnc_exon, individu_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
...
@define_variable(nbnc_exon, individu_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
...
@define_variable(mbnc_impo, individu_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
...
@define_variable(abnc_impo, individu_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
...
@define_variable(abnc_defi, individu_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
...
@define_variable(nbnc_impo, individu_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
...
@define_variable(nbnc_defi, individu_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
...
@define_variable(mbnc_mvct, individu_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
...
@define_variable(frag_pvct, individu_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
...
@define_variable(mbic_pvct, individu_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
...
@define_variable(macc_pvct, individu_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
...
@define_variable(mbnc_pvct, individu_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
...
@define_variable(mncn_pvct, individu_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
...
@define_variable(mbic_mvlt, individu_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
...
@define_variable(macc_mvlt, individu_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
...
@define_variable(mncn_mvlt, individu_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
...
@define_variable(mbnc_mvlt, individu_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
...
@define_variable(frag_pvce, individu_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
...
@define_variable(arag_pvce, individu_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
...
@define_variable(nrag_pvce, individu_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
...
@define_variable(mbic_pvce, individu_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
...
@define_variable(abic_pvce, individu_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
...
@define_variable(nbic_pvce, individu_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
...
@define_variable(macc_pvce, individu_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
...
@define_variable(aacc_pvce, individu_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
...
@define_variable(nacc_pvce, individu_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
...
@define_variable(mncn_pvce, individu_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
...
@define_variable(cncn_pvce, individu_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
...
@define_variable(mbnc_pvce, individu_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
...
@define_variable(abnc_pvce, individu_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
...
@define_variable(nbnc_pvce, individu_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
...
@define_variable(frag_fore, individu_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
...
@define_variable(arag_sjag, individu_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
...
@define_variable(abic_impm, individu_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
...
@define_variable(nbic_impm, individu_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
...
@define_variable(abic_defm, individu_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
...
@define_variable(alnp_imps, individu_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
...
@define_variable(alnp_defs, individu_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
...
@define_variable(nlnp_defs, individu_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
...
@define_variable(cbnc_assc, individu_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = [0 => "5QM", 1 => "5RM"],
...
@define_variable(abnc_proc, individu_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
...
@define_variable(nbnc_proc, individu_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
...
@define_variable(mncn_exon, individu_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
...
@define_variable(cncn_exon, individu_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
...
@define_variable(cncn_aimp, individu_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
...
@define_variable(cncn_adef, individu_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
...
@define_variable(cncn_info, individu_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
...
@define_variable(cncn_jcre, individu_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
...
@define_variable(revimpres, individu_definition, Int32, requested_period_default_value,
  cell_format = "monetary",
  cerfa_field = [0 => "5HY", 1 => "5IY", 2 => "5JY"],
  label = "Revenus nets à imposer aux prélèvements sociaux",
)

@define_variable(pveximpres, individu_definition, Int32, requested_period_default_value,
...
@define_variable(pvtaimpres, individu_definition, Int32, requested_period_default_value,
  cerfa_field = [0 => "5HZ", 1 => "5IZ", 2 => "5JZ"],
...
@define_variable(arrco_tranche_a_taux_employeur, individu_definition, Float32, requested_period_default_value,
  label = "Taux ARRCO tranche A employeur) propre à l'entreprise",
)

@define_variable(arrco_tranche_a_taux_salarie, individu_definition, Float32, requested_period_default_value,
  label = "Taux ARRCO tranche A salarié) propre à l'entreprise",
)

@define_variable(assujettie_taxe_salaires, individu_definition, Bool, requested_period_last_value,
  label = "Entreprise assujettie à la taxe sur les salaires",
)

@define_variable(avantages_en_nature_valeur_reelle, individu_definition, Float32, requested_period_default_value,
  label = "Avantages en nature (Valeur réelle)",
)

@define_variable(indemnites_compensatrices_conges_payes, individu_definition, Float32, requested_period_default_value)

@define_variable(contrat_de_travail, individu_definition, Int16, requested_period_last_value,
...
@define_variable(contrat_de_travail_arrivee, individu_definition, Date, requested_period_last_value,
  cell_default = Date(1870, 1, 1),
  cell_format = "date",
  label = "Date d'arrivée dans l'entreprise",
)

@define_variable(contrat_de_travail_depart, individu_definition, Date, requested_period_last_value,
  cell_default = Date(2099, 12, 31),
  cell_format = "date",
  label = "Date de départ de l'entreprise",
)

@define_variable(contrat_de_travail_duree, individu_definition, Int16, requested_period_last_value,
...
@define_variable(cotisation_sociale_mode_recouvrement, individu_definition, Int16, requested_period_last_value,
  label = "Mode de recouvrement des cotisations sociales",
  values = [
    "Mensuel avec régularisation en fin d'année" => 0,
    "Annuel" => 1,
  ],
)

@define_variable(effectif_entreprise, individu_definition, Int32, permanent_default_value,
  label = "Effectif de l'entreprise",
  permanent = true,
)

@define_variable(localisation_entreprise, individu_definition, UTF8String, requested_period_last_value,
  label = "Localisation entreprise",
)

@define_variable(nombre_tickets_restaurant, individu_definition, Int32, requested_period_default_value,
  label = "Nombre de tickets restaurant",
)

@define_variable(nouvelle_bonification_indiciaire, individu_definition, Float32, requested_period_default_value,
  label = "Nouvelle bonification indicaire",
)

@define_variable(prevoyance_obligatoire_cadre_taux_employe, individu_definition, Float32, requested_period_default_value,
  cell_default = 0.015,
  label = "Taux de cotisation employeur pour la prévoyance obligatoire des cadres",
)

@define_variable(prevoyance_obligatoire_cadre_taux_employeur, individu_definition, Float32, requested_period_default_value,
  cell_default = 0.015,
  label = "Taux de cotisation employeur pour la prévoyance obligatoire des cadres",
)

@define_variable(primes_salaires, individu_definition, Float32, requested_period_default_value,
  label = "Indemnités, primes et avantages en argent",
)

@define_variable(prise_en_charge_employeur_prevoyance_complementaire, individu_definition, Float32, requested_period_default_value,
  label = "Part salariale des cotisations de prévoyance complémentaire prise en charge par l'employeur",
)

@define_variable(prise_en_charge_employeur_retraite_complementaire, individu_definition, Float32, requested_period_default_value,
  label = "Part salariale des cotisations de retraite complémentaire prise en charge par l'employeur",
)

@define_variable(prise_en_charge_employeur_retraite_supplementaire, individu_definition, Float32, requested_period_default_value,
  label = "Part salariale des cotisations de retraite supplémentaire prise en charge par l'employeur",
)

@define_variable(ratio_alternants, individu_definition, Float32, requested_period_default_value,
  label = "Ratio d'alternants dans l'effectif moyen",
)

@define_variable(redevable_taxe_apprentissage, individu_definition, Bool, requested_period_last_value,
  cell_default = true,
  label = "Entreprise redevable de la taxe d'apprentissage",
)

@define_variable(remboursement_transport_base, individu_definition, Float32, requested_period_default_value,
  label = "Base pour le calcul du remboursement des frais de transport",
)

@define_variable(indemnites_forfaitaires, individu_definition, Float32, requested_period_default_value,
  label = "Indemnités forfaitaires (transport, nourriture)",
)

@define_variable(salaire_de_base, individu_definition, Float32, requested_period_default_value,
  label = "Salaire de base",
)

@define_variable(titre_restaurant_taux_employeur, individu_definition, Float32, requested_period_default_value,
  cell_default = 0.5,
  label = "Taux de participation de l'employeur au titre restaurant",
)

@define_variable(titre_restaurant_valeur_unitaire, individu_definition, Float32, requested_period_default_value,
  label = "Valeur faciale unitaire du titre restaurant",
)

@define_variable(titre_restaurant_volume, individu_definition, Int32, requested_period_default_value,
  label = "Volume des titres restaurant",
)

@define_variable(traitement_indiciaire_brut, individu_definition, Float32, requested_period_default_value,
  label = "Traitement indiciaire brut (TIB)",
)

@define_variable(type_sal, individu_definition, Int16, requested_period_last_value,
...
@define_variable(heures_duree_collective_entreprise, individu_definition, Int32, requested_period_default_value,
  label = "Durée mensuelle collective dans l'entreprise (heures, temps plein)",
)

@define_variable(heures_non_remunerees_volume, individu_definition, Float32, requested_period_default_value,
  label = "Volume des heures non rémunérées (convenance personnelle hors contrat/forfait)",
)

@define_variable(heures_remunerees_volume, individu_definition, Float32, requested_period_default_value,
  label = "Volume des heures rémunérées contractuellement (heures/mois, temps partiel)",
)

@define_variable(forfait_heures_remunerees_volume, individu_definition, Int32, requested_period_default_value,
  label = "Volume des heures rémunérées à un forfait heures",
)

@define_variable(forfait_jours_remuneres_volume, individu_definition, Int32, requested_period_default_value,
  label = "Volume des heures rémunérées à forfait jours",
)

@define_variable(volume_jours_ijss, individu_definition, Int32, requested_period_default_value,
...
@define_variable(partiel1, famille_definition, Bool, requested_period_last_value,
  label = "Parent actif à moins de 50% (PAJE-CLCA)",
)

@define_variable(partiel2, famille_definition, Bool, requested_period_last_value,
  label = "Parent actif entre 50% et 80% (PAJE-CLCA)",
)

@define_variable(opt_colca, famille_definition, Bool, requested_period_last_value,
  label = "Opte pour le COLCA",
)

@define_variable(empl_dir, famille_definition, Bool, requested_period_last_value,
  label = "Emploi direct (CLCMG)",
)

@define_variable(ass_mat, famille_definition, Bool, requested_period_last_value,
