...
function test_irpp(year, irpp; variables_value_by_name...)
  test_irpp_once(year, irpp; variables_value_by_name...)
  @time test_irpp_once(year, irpp; variables_value_by_name...)
end


function test_irpp_once(year, irpp; variables_value_by_name...)
